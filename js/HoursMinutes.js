...
exports.dateArray = exports.convertToDateArray = exports.convertToDate = exports.toMinutes = exports.add = exports.normalise = void 0;
...
function add() {
    ...
    try {
        for (var args_1 = __values(args), args_1_1 = args_1.next(); !args_1_1.done; args_1_1 = args_1.next()) {
            var _b = args_1_1.value, hours = _b.hours, minutes = _b.minutes;
            total.hours += hours;
...
exports.dateArray = function (date) { return [
    date.getFullYear(),
    date.getMonth() + 1,
    date.getDate(),
    date.getHours(),
