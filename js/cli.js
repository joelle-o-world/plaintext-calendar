...
var convertToICS_1 = __importDefault(require("./convertToICS"));
var child_process_1 = __importDefault(require("child_process"));
var filepath = process.argv[2];
var outputPath = filepath + ".ics";
fs_1.default.readFile(filepath, { encoding: "utf8" }, function (err, file) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          if (err) throw err;
          (_a = parseCalendarText_1.default(file, { filepath: filepath })),
            (events = _a.events),
